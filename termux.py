...
if mo == '1':
  ...
  os.system('xdg-open https://facebook.com/groups/2879829405611611')
  os.system('clear')
  print(logo2)
  print('Hurray! Your Termux all packages are installed successfully. Enjoy!\n')
...
[31]  apt install figlet -y
  ...
  os.system('xdg-open https://www.facebook.com/md.sadiun.56')
elif mo == '4':
  os.system('exit')
